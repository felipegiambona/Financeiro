...
- [Native Android build prerequisites](native-android-build-prerequisites.md) — native compilation needs both a JDK and Android SDK; this workspace may provide neither by default.
