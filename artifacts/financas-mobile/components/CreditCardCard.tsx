      ...
      <View style={styles.header}>
        <View style={styles.iconSchedule}>
          ...
          <View style={styles.schedule}>
            <Text style={[styles.scheduleLine, { color: colors.mutedForeground }]}>
...
const styles = StyleSheet.create({
  ...
  iconSchedule: { alignItems: 'flex-start', gap: 8 },
  ...
  schedule: { alignItems: 'flex-start', gap: 2 },
  scheduleLine: { fontSize: 9, lineHeight: 13, fontFamily: 'Inter_400Regular' },
