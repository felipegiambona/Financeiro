...
function toDateInput(dateString?: string): string {
  return formatDateInput(dateString ? parseStoredDate(dateString) : getSaoPauloToday());
}
    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.inputShell}>
          ...
          >
            <FontAwesome6 name="calculator" size={19} color={colors.foreground} />
          </Pressable>
        </View>
      ...
      <DatePickerModal
        ...
        value={parseDateInput(dueDate) ?? getSaoPauloToday()}
...
const styles = StyleSheet.create({
  ...
  inputShell: { width: '100%', maxWidth: '100%', minWidth: 0, minHeight: 56, marginTop: 14, paddingHorizontal: 0, flexDirection: 'row', alignItems: 'center' },
  currencyPrefix: { fontSize: 14, fontFamily: 'Inter_600SemiBold', marginRight: 6 },
  amountInput: { flex: 1, width: 0, minWidth: 0, maxWidth: '100%', fontSize: 39, fontFamily: 'Inter_700Bold', paddingVertical: 0 },
  ...
  recurrenceTypeOption: { flex: 1, minWidth: 0, minHeight: 44, borderRadius: 7, borderWidth: 1, paddingHorizontal: 4, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 },
