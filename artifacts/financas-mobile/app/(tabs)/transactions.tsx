...
const styles = StyleSheet.create({
  ...
  monthHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 13 },
  monthTitle: { fontSize: 17, fontFamily: 'Inter_700Bold' },
  monthArrows: { flexDirection: 'row', gap: 7 },
  arrow: { width: 34, height: 34, borderRadius: 12, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  months: { gap: 9, paddingBottom: 18 },
  monthChip: { width: 74, minHeight: 60, borderRadius: 16, borderWidth: 1, alignItems: 'center', justifyContent: 'center', gap: 3 },
  monthChipText: { fontSize: 12, fontFamily: 'Inter_600SemiBold', textTransform: 'capitalize' },
  monthChipYear: { fontSize: 11, fontFamily: 'Inter_500Medium' },
  metrics: { flexDirection: 'row', gap: 10, marginBottom: 28 },
  metric: { flex: 1, minHeight: 82, borderRadius: 17, borderWidth: 1, padding: 14, justifyContent: 'space-between' },
