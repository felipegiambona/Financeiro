    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={[styles.automationCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          {Platform.OS !== 'android' ? (
            <Text style={[styles.automationStatus, { color: colors.mutedForeground }]}>
              Disponível somente em development build Android.
            </Text>
          ) : !notificationListenerAvailable ? (
            <Text style={[styles.automationStatus, { color: colors.mutedForeground }]}>
              Instale uma development build para ativar esta função.
            </Text>
          ) : (
            <>
              <View style={[styles.divider, { backgroundColor: colors.border }]} />
