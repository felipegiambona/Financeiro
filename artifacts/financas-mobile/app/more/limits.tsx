...
const styles = StyleSheet.create({
  ...
  modalScroll: { width: 340, flexShrink: 1, alignSelf: 'center' },
  modalScrollContent: { flexGrow: 1, width: 340, alignItems: 'stretch', justifyContent: 'center', paddingVertical: 18 },
  modalCard: { width: 340, maxHeight: '82%', borderRadius: 12, borderWidth: 1, padding: 14, flexShrink: 1 },
